...
-- Safe to run multiple times. Skipped silently if storage schema is absent.
...
IF NOT EXISTS (
    ...
    RAISE NOTICE '0007_Storage: storage schema not found – skipping.';
    RETURN;
END IF;
...
RAISE NOTICE '0007_Storage: bucket jesterx + 4 RLS policies applied.';
