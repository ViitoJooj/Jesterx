-- 0008_Seed.up.sql
-- Default platform data: JesterX website, subscription plans, starter themes.

INSERT INTO websites (
    id, website_type, image_url, name, short_description, description,
    creator_id, banned, mature_content, rating_avg, rating_count,
...
INSERT INTO plans (id, name, description, description_md, features, price, billing_cycle, active, max_sites, max_routes, created_at, updated_at) VALUES
(
    'plan-starter',
    'Starter',
    'Para criadores independentes que querem mais controle.',
    E'## Starter\n\nPara criadores independentes que querem mais controle.\n\n- **1 site**\n- 7 rotas por site\n- Acesso ao editor visual\n- Suporte por e-mail',
    '["1 site","7 rotas por site","Editor visual","Suporte por e-mail"]',
    29.90, 'monthly', TRUE, 1, 7, NOW(), NOW()
),
(
    'plan-pro',
    'Pro',
    ...
    '["5 sites","35 rotas por site","Editor visual avançado","Suporte prioritário"]',
    79.90, 'monthly', TRUE, 5, 35, NOW(), NOW()
),
(
    'plan-business',
    'Business',
    ...
    E'## Business\n\nPara agências e empresas com alto volume.\n\n- **15 sites**\n- 105 rotas por site\n- Recursos exclusivos\n- Suporte dedicado',
    '["15 sites","105 rotas por site","Recursos exclusivos","Suporte dedicado"]',
    199.90, 'monthly', TRUE, 15, 105, NOW(), NOW()
)
ON CONFLICT (id) DO NOTHING;
