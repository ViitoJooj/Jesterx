...
-- Platform website (creator_id is a placeholder — no real user row)
INSERT INTO websites (
    id, website_type, name, short_description, description,
...
-- Subscription plans
INSERT INTO plans (id, name, description, description_md, price, billing_cycle, active, max_sites, max_routes, created_at, updated_at) VALUES
(
    'plan-starter',
    'Starter',
