...
## quem Irá utilizar ?:
> Jesterx é um saas multi tenant para empresas e usuarios, com foco ao uso global.
...
- RF06 - Os websites criados pelos usuarios terão auth próprio, vai funcionar básicamente como o Jesterx.
...
- RF11 - Se o envio não houver X-Website o envio vai ser para a jesterx
