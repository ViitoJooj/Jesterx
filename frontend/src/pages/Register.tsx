    ...
    <main className={styles.main}>
      <div className={styles.container}>
        ...
        <div className={styles.oauth_buttons}>
          <button type="button" onClick={() => window.location.href = `${url}/v1/auth/google`} className={styles.oauth_button}>
          ...
          <button type="button" onClick={() => window.location.href = `${url}/v1/auth/github`} className={styles.oauth_button}>
