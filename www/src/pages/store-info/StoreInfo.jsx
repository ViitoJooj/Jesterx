...
export function StoreInfo() {
  ...
  async function handleUpdateRole(memberUserId, newRole) {
  ...
  async function handleDeleteSite() {
    if (!siteId || !accessToken || deleteTyped !== store.name) return;
    setDeleting(true);
    try {
      await apiFetch(`/api/v1/sites/${siteId}`, { websiteId, accessToken, method: "DELETE" });
      navigate(-1);
    } catch {
      setDeleting(false);
    }
  ...
  return (
    <main className={styles.main}>
      <div className={styles.layout}>
        ...
        <aside className={styles.sidebar}>
          ...
          <div className={styles.storeCard}>
            <div className={styles.storeCardBanner} />
        ...
        <div className={styles.content}>
          ...
          {/* Stats row — visible to team members prominently, lighter for visitors */}
          <div className={styles.statsGrid}>
            <div className={styles.statCard}>
              <span className={styles.statValue}>{visits.reduce((s, d) => s + d.count, 0)}</span>
              <span className={styles.statLabel}>Visitas (30 dias)</span>
            </div>
            <div className={styles.statCard}>
            ...
            <div className={styles.statCard}>
              <span className={styles.statValue}>{store.rating_avg.toFixed(1)}<span className={styles.statStar}>★</span></span>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.previewDevice}>
              <div className={styles.previewBar}>
                ...
                <div className={styles.previewUrl}>{`${API_URL}/p/${store.id}`}</div>
              </div>
          ...
          {canManageMembers && (
            <section className={`${styles.section} ${styles.adminSection}`}>
              <h2><span className={styles.adminBadge}>Admin</span> Membros da Equipe</h2>
              <div className={styles.sectionInner}>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.sectionInner}>
            {/* Owners/team don't comment on their own store */}
            {user && !isOwner && !canReply ? (
              ...
              <div className={styles.sectionInner}>
                <div className={styles.dangerZoneBody}>
                  <div className={styles.dangerZoneText}>
                    <strong>Excluir este site permanentemente</strong>
                    <p>Esta ação é irreversível. O site, todas as versões, produtos, pedidos e dados associados serão apagados para sempre.</p>
                  </div>
                  <button
                    type="button"
      ...
      {deleteConfirm && (
        <div className={styles.deleteOverlay} onClick={() => !deleting && setDeleteConfirm(false)}>
          <div className={styles.deleteModal} onClick={(e) => e.stopPropagation()}>
            <div className={styles.deleteModalIcon}>⚠️</div>
            <h2 className={styles.deleteModalTitle}>Excluir site permanentemente</h2>
            <p className={styles.deleteModalText}>
              Esta ação é <strong>irreversível</strong>. O site, todas as versões, produtos, pedidos e dados associados serão apagados para sempre.
            </p>
            <p className={styles.deleteModalLabel}>
            ...
            <div className={styles.deleteModalActions}>
              ...
              <button
                ...
                disabled={deleting || deleteTyped !== store.name}
