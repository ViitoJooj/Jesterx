  ...
  async function handleRegister(e?: React.FormEvent) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setStatus("error");
        setMessage(data.message || "Não foi possível criar sua conta.");
      }
    } catch (err) {
      setStatus("error");
        ...
        <form onSubmit={handleRegister} noValidate>
          <div className={styles.input_container}>
            <div>
              ...
              <Input id="firstName" value={firstName} onChange={(e) => setFirstName(e.target.value)} placeholder="João" type="text" autoComplete="given-name" className={inputStyles.default_input} required />
            </div>

            <div>
              <label htmlFor="lastName">Sobrenome:</label>
              <Input id="lastName" value={lastName} onChange={(e) => setLastName(e.target.value)} placeholder="Silva" type="text" autoComplete="family-name" className={inputStyles.default_input} required />
            </div>
          </div>
          ...
          <div className={styles.checkbox_row}>
            ...
            <label htmlFor="keepMeLoggedIn">Manter-me conectado</label>
          </div>

          <Button type="submit" label={loading ? "Criando conta…" : "Registrar"} disabled={loading} className={`${buttonStyles.default_button} ${buttonStyles["default_button--primary"]} ${styles.cta_button}`} />
        </form>
